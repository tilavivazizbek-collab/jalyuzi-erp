    ...
    <form action={yubor} className="flex flex-col gap-3 border-t border-chegara px-4 py-3">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          value="TASDIQ"
          disabled={kutilmoqda}
          className="rounded-maydon bg-brend px-4 py-2 text-sm font-medium text-tugma-matn transition-all active:scale-[0.98] hover:bg-brend-quyuq disabled:opacity-60"
        >
        ...
        <button
          ...
          value="RAD"
          disabled={kutilmoqda}
          className="rounded-maydon border border-chegara-quyuq px-4 py-2 text-sm text-matn-ikki transition-all active:scale-[0.98] hover:bg-fon disabled:opacity-60"
        >
          Rad etish
        </button>
      </div>
