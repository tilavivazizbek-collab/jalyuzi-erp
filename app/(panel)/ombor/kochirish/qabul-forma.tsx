  ...
  return (
    <form action={yubor} className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={kutilmoqda}
        className="self-start rounded-maydon bg-belgi-yashil px-3.5 py-2 text-sm font-medium text-tugma-matn transition-all active:scale-[0.98] hover:brightness-95 disabled:opacity-60"
      >
