  ...
  return (
    <form action={yubor} className="flex items-center gap-2">
      ...
      <button
        type="submit"
        disabled={kutilmoqda}
        className="rounded-maydon bg-belgi-yashil px-3 py-1.5 text-xs font-medium text-tugma-matn transition-all active:scale-[0.98] hover:brightness-95 disabled:opacity-60"
      >
  ...
  return (
    <form action={yubor} className="flex items-center gap-2">
      ...
      <button
        type="submit"
        disabled={kutilmoqda}
        className="rounded-maydon bg-brend px-3 py-1.5 text-xs font-medium text-tugma-matn transition-all active:scale-[0.98] hover:bg-brend-quyuq disabled:opacity-60"
      >
    ...
    <form action={yubor} className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-3">
        <button
          type="submit"
          disabled={kutilmoqda}
          className="rounded-maydon bg-belgi-qizil px-3 py-1.5 text-xs font-medium text-tugma-matn transition-all active:scale-[0.98] hover:brightness-95 disabled:opacity-60"
        >
