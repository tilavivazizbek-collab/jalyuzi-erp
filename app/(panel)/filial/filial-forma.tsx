  ...
  return (
    <form action={yubor} className="flex max-w-2xl flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={kutilmoqda}
        className="self-start rounded-maydon bg-brend px-3.5 py-2 text-sm font-medium text-tugma-matn transition-all active:scale-[0.98] hover:bg-brend-quyuq disabled:opacity-60"
      >
