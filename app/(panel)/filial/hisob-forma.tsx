  ...
  if (!ochiq) {
    return (
      <button
        ...
        className="self-start rounded-maydon bg-brend px-3.5 py-2 text-sm font-medium text-tugma-matn transition-all active:scale-[0.98] hover:bg-brend-quyuq"
      >
        Qarzni to&apos;lash
      </button>
    );
    ...
    <form action={yubor} className="flex max-w-2xl flex-col gap-3">
      ...
      <div className="flex items-center gap-3">
        <button
          type="submit"
          disabled={kutilmoqda}
          className="rounded-maydon bg-belgi-sariq px-3 py-1.5 text-xs font-medium text-tugma-matn transition-all active:scale-[0.98] hover:brightness-95 disabled:opacity-60"
        >
