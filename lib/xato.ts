...
export const XATO_BAND = {
  ...
  YOZUV_YOQ: "QISM 1 §6.5 — o'chiriladigan yozuv topilmadi",
  ...
  /** TZ 9.9 — yetkazib beruvchiga da'vo */
  DAVO_YOQ: 'TZ 9.9',
  DAVO_YOPILGAN: 'TZ 9.9',
  KIRIM_STORNO_QILINGAN: 'TZ 7.12',
  /** TZ 9.11 — qo'shimcha xarajat manfiy bo'lmaydi */
  KIRIM_XARAJAT_MANFIY: 'TZ 9.11',
  ...
  TOLOV_KALIT_KERAK: 'TZ 12.3',
  BUYURTMA_FILIAL_KERAK: 'TZ 20.4.1',
  BUYURTMA_SAQLANMADI: 'TZ 3.9',
  /** Butun buyurtmani o'chirish — TZ 8.8 · 8.15 */
  BUYURTMA_SABAB_KERAK: 'TZ 8.8',
  /** TZ 8.8 — storno: sotuvchining xatosi, bekor qilishdan alohida */
  BUYURTMA_STORNO_QILINGAN: 'TZ 8.8',
  BUYURTMA_TOLANGAN: 'TZ 8.8',
  BUYURTMA_TOPSHIRILGAN: 'TZ 8.10',
  BUYURTMA_ISHDA: 'TZ 8.8',
