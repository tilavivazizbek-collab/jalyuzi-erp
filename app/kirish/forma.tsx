    ...
    <form action={amal} className="flex flex-col gap-4">
      ...
      */}
      ...
      <button
        type="submit"
        disabled={kutilmoqda}
        className="mt-1 h-11 rounded-[6px] bg-brend text-base font-medium text-tugma-matn transition-all active:scale-[0.98] hover:bg-brend-quyuq disabled:cursor-not-allowed disabled:opacity-60"
      >
