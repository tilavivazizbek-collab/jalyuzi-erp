    ...
    <form action={yubor} className="flex max-w-xl flex-col gap-6">
      ...
      <div className="flex items-center gap-3">
        <button
          type="submit"
          disabled={kutilmoqda}
          className="rounded-maydon bg-belgi-qizil px-4 py-2 text-sm font-medium text-tugma-matn transition-all active:scale-[0.98] hover:brightness-95 disabled:opacity-60"
        >
