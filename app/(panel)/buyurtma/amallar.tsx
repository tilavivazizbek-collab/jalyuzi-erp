      ...
      */}
      ...
      <div className="flex items-center gap-3">
        <button
          type="submit"
          disabled={kutilmoqda}
          className="rounded-maydon bg-belgi-qizil px-3 py-1.5 text-xs font-medium text-tugma-matn transition-all hover:brightness-95 active:scale-[0.98] disabled:opacity-60"
        >
