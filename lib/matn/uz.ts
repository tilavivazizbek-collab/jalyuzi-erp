...
export const XATO_MATNI: Record<XatoKod, string> = {
  ...
  SARFLASH_MOS_EMAS:
    "Ombor sarflashi mos kelmadi — sahifani yangilang va qaytadan kiriting",
  ...
  DAVO_YOQ: "Bu qatorda da'vo yo'q",
  DAVO_YOPILGAN: "Da'vo allaqachon hal qilingan",
  KIRIM_STORNO_QILINGAN: "Kirim storno qilingan — da'vo hal qilinmaydi",
  KIRIM_XARAJAT_MANFIY: "Transport va bojxona manfiy bo'lmaydi",
  ...
  ISH_STAVKA_NOTOGRI: "To'lanadigan summa manfiy bo'la olmaydi",
  ...
  HOLAT_QOLDA_QOYILMAYDI:
    "Bu holat qo'lda qo'yilmaydi — «Ishga oldim» yoki «Tugatdim» orqali o'tiladi",
  ...
  OLCHAM_NOTOGRI: "O'lcham noto'g'ri",
  ...
  BUYURTMA_SABAB_KERAK: "O'chirish sababini yozing",
  BUYURTMA_STORNO_QILINGAN: "Buyurtma allaqachon storno qilingan",
  BUYURTMA_TOLANGAN: "Buyurtma bo'yicha to'lov qilingan",
  BUYURTMA_TOPSHIRILGAN: "Buyurtmaning bir qismi topshirilgan",
  BUYURTMA_ISHDA: "Buyurtma ishlab chiqarishda",
