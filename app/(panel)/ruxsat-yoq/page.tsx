...
export default async function RuxsatYoq({
  ...
  return (
    <div className="mx-auto max-w-md py-16 text-center">
      ...
      <Link
        href="/boshqaruv"
        className="mt-6 inline-block rounded-maydon bg-brend px-4 py-2 text-sm font-medium text-tugma-matn transition-all active:scale-[0.98] hover:bg-brend-quyuq"
      >
        Boshqaruvga qaytish
      </Link>
    </div>
